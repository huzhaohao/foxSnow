...
//  snow
//
//  Created by huzhaohao on 2018/8/25.
...
-(CAEmitterLayer*)flakeLayer{
    if (_flakeLayer==nil) {
        _flakeLayer = [CAEmitterLayer layer];
...
//        _flakeLayer.emitterMode    = kCAEmitterLayerOutline;//发射模式
        ...
        _flakeLayer.emitterShape = kCAEmitterLayerRectangle;
        _flakeLayer.emitterMode    = kCAEmitterLayerSurface;//发射模式
